...
import { Sparkles, Rocket, Sword, Shield, Star, Zap, Globe } from "lucide-react";
    ...
    <div className={styles.container}>
          ...
          <div className={styles.languageInfo}>
            ...
            <div>
              <p className={styles.languageLabel}>
                <strong>{t("demo.currentLanguage")}:</strong> {locale} - {t("common.welcome")}
              </p>
      ...
      <Card title="Progress Bars & Sliders" variant="default">
        <div className={styles.progressGroup}>
          ...
          <div>
            ...
            <ProgressBar value={90} variant="secondary" size="medium" showLabel />
          </div>
      ...
      <Card title="States Guide" variant="default">
        <ul className={styles.guide}>
          <li><strong>Idle:</strong> Stars float gently</li>
          <li><strong>Hover:</strong> Stars move outward, border glows and animates</li>
          <li><strong>Click:</strong> Stars burst outward with rotation</li>
          <li><strong>Loading:</strong> Spinner animation, border slides continuously</li>
          <li><strong>Disabled:</strong> Grayscale, no animations</li>
        </ul>
      </Card>
      ...
      >
        <div className={styles.modalContent}>
          ...
          <p>
            This modal features the same fantasy-scifi design language as the buttons,
            with animated borders, floating stars, and smooth animations.
          </p>
          <p>
            The modal opens from the center with a 3D rotation effect and closes with
            the reverse animation. Stars burst in when opening and float gently.
          </p>
          <div className={styles.buttonGroup} style={{ marginTop: "1.5rem" }}>
            <Button icon={<Sparkles size={18} />}>
              Action Button
            </Button>
      ...
      >
        <div className={styles.modalContent}>
          ...
          <p>
            ...
            You can close it by clicking outside the modal or using a button inside.
          </p>
          <div className={styles.buttonGroup} style={{ marginTop: "1.5rem" }}>
            <Button variant="secondary" onClick={() => setIsNoTitleModalOpen(false)}>
              Close
            </Button>
          </div>
        </div>
